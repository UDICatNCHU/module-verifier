...
- **「全年課」學分語義釐清(2026-04-23 發現)**: 24 個模組課程學分 ≥ 4 且學生普遍修兩學期,但備註無「選修兩學期」(如普通物理學 6 學分 / 563 位、生物化學 6 學分 / 280 位、經濟學原理 6 學分 × 3 模組)。系統目前只計第一學期學分,可能低估。需向校方確認「模組課程學分」是單學期還是全年合計;若為全年,應在這些 row 的備註補「選修兩學期」,Bug #2 的修復邏輯(commit `8f229c1`)會自動套用。
